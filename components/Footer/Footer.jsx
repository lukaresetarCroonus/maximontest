    ...
    <div className="mt-[80px]">
      ...
      <footer className="block mx-0 w-[90%] 2xl:w-[85%] max-md:w-full max-sm:mx-0 md:mx-auto">
        ...
        <div className="px-1 py-12 grid  grid-cols-1 md:grid-cols-4 gap-2 md:gap-8 max-md:text-center ">
          ...
          <div className="flex flex-row sm:mb-4" onClick={() => setOpen({ id: open?.id === 1 ? null : 1 })}>
            ...
            <ul className={`sm:block ${open?.id == 1 ? 'block': "hidden"} text-sm text-gray-600`}>
              <li>
          ...
          <div className="flex flex-col items-center md:items-start mb-2 pl-3 mt-6">
            <div className="flex flex-row sm:mb-4" onClick={() => setOpen({ id: open?.id === 2 ? null : 2 })}>
            ...
            <ul className={`sm:block ${open?.id == 2 ? 'block': "hidden"}  text-sm text-gray-600`}>
              <li>
                <Link href="/kako-kupiti-online">Kako kupiti online</Link>
              </li>
              <li>
                <Link href="/strana/reklamacije">Reklamacije</Link>
              </li>
              <li>
                <Link href="/strana/pravo-na-odustajanje">Pravo na odustajanje</Link>
              </li>
              <li>
                <Link href="/strana/zamena-artikala">Pravo na zamenu</Link>
              </li>
              <li>
                <Link href="/strana/nacini-i-uslovi-placanja">Načini plaćanja</Link>
              </li>
            </ul>
          </div>

          <div className="flex flex-col items-center md:items-start mb-2 pl-4 mt-6">
          <div className="flex flex-row sm:mb-4" onClick={() => setOpen({ id: open?.id === 3 ? null : 3 })}>
            <h3 className="text-normal font-light uppercase" >
              Uslovi korišćenja
            </h3>
            <span
            ...
            <ul className={`sm:block ${open?.id == 3 ? 'block': "hidden"} text-sm text-gray-600`}>
              <li>
                <Link href="/strana/opsti-uslovi-kupovine-alti-moda">
