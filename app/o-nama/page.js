...
const Onama = async () => {
    ...
    return (
        <>
            ...
            <div style={{ marginTop: "2.8%", width: "94.5%", marginLeft: "auto", marginRight: "auto" }}>
                        ...
                        case "html_editor":
                            return (
                                <div key={keyGenerator("html")} className="relative">
                                    {/* Bela kartica koja prekriva deo slike */}
                                    <div
                                        className="relative bg-white shadow-md p-10 mx-auto  font-lato max-w-[50%] md:max-w-[80%]"
